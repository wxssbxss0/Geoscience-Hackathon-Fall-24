...
class NavierStokes():
    def __init__(self, X, Y, T, u, v):
        ...
        self.optimizer = torch.optim.LBFGS(self.net.parameters(), lr=1, max_iter=400, max_eval=1000,
    ...
    def closure(self):
        ...
        print('Data loss: ', (u_loss + v_loss))
        print('Physical loss: ', (f_loss + g_loss))
...
data = scipy.io.loadmat('Cylinder-Wake/cylinder_wake.mat')
...
pinn = NavierStokes(x_train, y_train, t_train, u_train, v_train)
pinn.net.load_state_dict(torch.load('Cylinder-Wake/model.pt'))
...
def animate(i):
    ...
    cax = ax.contourf(u_plot, levels=20, cmap='viridis')
